...
простое, но работает слишком медленно. 
   Нужно или использовать кэширование либо подойти к решению с другой стороны, например не 
   

Достаточно сложно было понять как можно 
   оптимизировать код и что закэшировать.
